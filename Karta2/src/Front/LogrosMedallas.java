 ...
 * @author nisit
 */
public class LogrosMedallas extends javax.swing.JFrame {

    /**
     * Creates new form Iniciar
     */
    public LogrosMedallas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogrosMedallas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LogrosMedallas().setVisible(true);
            }
        });
    }
